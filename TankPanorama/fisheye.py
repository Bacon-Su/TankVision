...
class Fisheye(threading.Thread):
    def __init__(self,paramsfile,camera_name):
...
if __name__ == "__main__":
    ...
    cv2.imshow("undistorted", cv2.resize(undistorted, None, fx=0.5, fy=0.5))
    cv2.imshow("align", cv2.resize(align, None, fx=0.5, fy=0.5))
