...
class Panorama(threading.Thread):
    def __init__(self,images):
        ...
        self.OV_FOV = 20
        self.F_FOV = (45 , 45) #120 ->100 50,50
        self.L_FOV = (45 , 35) #110 -> 90 50,40  
        self.R_FOV = (35 , 45) #110 -> 90 40,50
        self.B_FOV = (35 , 35) #100 -> 80 40,40
    ...
    def run(self):
        ...
        while not self.stopflag:
            # 创建线程并启动
            self.fisheyes[0].queue_in.put(self.imagespath[0])
            self.fisheyes[1].queue_in.put(self.imagespath[1])
            self.fisheyes[2].queue_in.put(self.imagespath[2])
            self.fisheyes[3].queue_in.put(self.imagespath[3])
